        ...
        >
          <span className="theme-toggle__track">
            <span
              ...
              aria-hidden="true"
            >
              <svg id="theme-toggle-sun-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span
              ...
              aria-hidden="true"
            >
              <svg id="theme-toggle-moon-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
